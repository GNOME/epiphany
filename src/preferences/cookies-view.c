...
G_DEFINE_TYPE (EphyCookiesView, ephy_cookies_view, EPHY_TYPE_PREFS_DATA_VIEW)
...
reload_model (EphyCookiesView *self)
{
  ...
  prefs_data_view_set_has_data (EPHY_PREFS_DATA_VIEW (self), FALSE);
  populate_model (self);
}
...
{
  prefs_data_view_set_has_search_results (EPHY_PREFS_DATA_VIEW (self), FALSE);
                             ...
                             EphyCookiesView          *self)
{
  ...
  prefs_data_view_set_is_loading (EPHY_PREFS_DATA_VIEW (self), FALSE);
  ...
  prefs_data_view_set_has_data (EPHY_PREFS_DATA_VIEW (self), TRUE);
}

static void
populate_model (EphyCookiesView *self)
{
  g_assert (!prefs_data_view_get_has_data (EPHY_PREFS_DATA_VIEW (self)));

  prefs_data_view_set_is_loading (EPHY_PREFS_DATA_VIEW (self), TRUE);
...
{
  EphyCookiesView *self = EPHY_COOKIES_VIEW (user_data);
  const gchar *search_text = prefs_data_view_get_search_text (EPHY_PREFS_DATA_VIEW (self));
  ...
  if (result)
    prefs_data_view_set_has_search_results (EPHY_PREFS_DATA_VIEW (self), TRUE);
