...
#include "clear-cookies-view.h"

struct _ClearCookiesView {
...
G_DEFINE_TYPE (ClearCookiesView, clear_cookies_view, GTK_TYPE_BOX)

static void populate_model (ClearCookiesView *self);
...
static void
reload_model (ClearCookiesView *self)
{
  clear_listbox (self->cookies_listbox);

  /* FIXME: Currently not inheriting from EphyDataDialog */
...
forget_clicked (GtkButton *button,
                gpointer   user_data)
{
  ClearCookiesView *self = EPHY_CLEAR_COOKIES_VIEW (user_data);
...
static void
on_search_text_changed (ClearCookiesView *self)
{
  /* FIXME: Currently not inheriting from EphyDataDialog */
...
static void
clear_cookies_view_class_init (ClearCookiesViewClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class,
                                               "/org/gnome/epiphany/gtk/clear-cookies-view.ui");

  gtk_widget_class_bind_template_child (widget_class, ClearCookiesView, cookies_listbox);

  gtk_widget_class_bind_template_callback (widget_class, on_search_text_changed);
}

static void
cookie_add (ClearCookiesView  *self,
...
static void
populate_model (ClearCookiesView *self)
{
  /* FIXME: Currently not inheriting from EphyDataDialog */
...
static GActionGroup *
create_action_group (ClearCookiesView *self)
{
...
static void
clear_cookies_view_init (ClearCookiesView *self)
{
