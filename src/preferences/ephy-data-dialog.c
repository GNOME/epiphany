                             ...
                             EphyDataDialog *self)
{
  ...
  GtkRevealer *selection_action_bar_revealer = GTK_REVEALER (priv->selection_action_bar_revealer);

  gtk_stack_set_visible_child (header_bars_stack, priv->selection_header_bar);
  gtk_revealer_set_reveal_child (selection_action_bar_revealer, TRUE);
}
                                    ...
                                    EphyDataDialog *self)
{
  ...
  gtk_revealer_set_reveal_child (selection_action_bar_revealer, FALSE);
}
