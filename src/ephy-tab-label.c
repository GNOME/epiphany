...
{
  gtk_widget_set_visible (self->close_button, !self->pin);
  gtk_widget_set_visible (self->label, !self->pin);
  gtk_widget_set_halign (GTK_WIDGET (self), self->pin ? GTK_ALIGN_CENTER : GTK_ALIGN_FILL);
