                         ...
                         EphyDataDialog *self)
{
  ...
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_SEARCH_TEXT]);
}
...
static void
ephy_data_dialog_dispose (GObject *object)
{
  EphyDataDialog *self = EPHY_DATA_DIALOG (object);
  EphyDataDialogPrivate *priv = ephy_data_dialog_get_instance_private (self);
  ...
  G_OBJECT_CLASS (ephy_data_dialog_parent_class)->dispose (object);
}
...
ephy_data_dialog_class_init (EphyDataDialogClass *klass)
{
  ...
  object_class->dispose = ephy_data_dialog_dispose;

  container_class->add = ephy_data_dialog_add;

  props[PROP_CLEAR_ALL_ACTION_NAME] =
  ...
  props[PROP_CLEAR_ALL_ACTION_TARGET] =
  ...
  props[PROP_CLEAR_ALL_DESCRIPTION] =
...
ephy_data_dialog_init (EphyDataDialog *self)
{
  ...
  /* priv->action_group = create_action_group (self); */
  /* gtk_widget_insert_action_group (GTK_WIDGET (self), "data", priv->action_group); */

  /* if (ephy_embed_shell_get_mode (shell) == EPHY_EMBED_SHELL_MODE_INCOGNITO) { */
  /*   tooltip = _("It is not possible to modify data when in incognito mode."); */
  /*   gtk_widget_set_tooltip_text (priv->clear_all_button, tooltip); */

  /*   action = g_action_map_lookup_action (G_ACTION_MAP (priv->action_group), "forget-all"); */
  /*   g_simple_action_set_enabled (G_SIMPLE_ACTION (action), FALSE); */

  /*   update_selection_actions (priv->action_group, FALSE); */
  /* } */
                                            ...
                                            const gchar    *description)
{
  ...
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_CLEAR_ALL_DESCRIPTION]);
}
                                         ...
                                         gboolean        has_search_results)
{
  ...
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_HAS_SEARCH_RESULTS]);
}
                                ...
                                gboolean        can_clear)
{
  ...
  g_object_notify_by_pspec (G_OBJECT (self), props[PROP_CAN_CLEAR]);
}
