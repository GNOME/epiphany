                         ...
                         EphyEmbed *embed)
{
  ...
  gboolean muted = webkit_web_view_is_audio_muted (WEBKIT_WEB_VIEW (view));

  webkit_web_view_set_is_audio_muted (WEBKIT_WEB_VIEW (view), !muted);
}
                 ...
                 EphyEmbed    *embed)
{
  ...
  g_signal_connect (tab_label, "audio-clicked", G_CALLBACK (audio_button_clicked_cb), embed);
  ...
  g_object_bind_property (view, "is-audio-muted", tab_label, "audio-muted", G_BINDING_DEFAULT | G_BINDING_SYNC_CREATE);
