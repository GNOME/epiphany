                              ...
                              gpointer     data)
{
  ...
  if (ephy_tab_label_is_pinned (tab_label))
    ephy_tab_label_set_attention (tab_label, FALSE);
                  ...
                  EphyNotebook *notebook)
{
  ...
  if (ephy_tab_label_is_pinned (tab_label)) {
    ...
    gint page_num = gtk_notebook_page_num (GTK_NOTEBOOK (notebook), GTK_WIDGET (embed));

    if (current_page != page_num)
      ephy_tab_label_set_attention (tab_label, TRUE);
  }
}
