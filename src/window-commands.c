                                        ...
                                        EphyApplicationDialogData *data)
{
  if (response == GTK_RESPONSE_OK) {
    ...
    if (desktop_file) {
      g_notification_add_button_with_target (notification, _("Launch"), "app.launch-app", "s", g_path_get_basename (desktop_file));
      g_notification_set_default_action_and_target (notification, "app.launch-app", "s", g_path_get_basename (desktop_file));
