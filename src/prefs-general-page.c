...
/* TODO: Maybe rename this to init_widgets() or something similar since
 * we know this is the General Page.
 * Keeping name for now to simplify splitting work
 */
static void
setup_general_page (PrefsGeneralPage *general_page)
{
  ...
  /* FIXME: The prefs_dialog isn't correctly fetched here,
   * hence the g_signal_connect() call below causes a warning */
  ...
  g_signal_connect (prefs_dialog, "response",
                    G_CALLBACK (prefs_dialog_response_cb), general_page);
