  ...
  while (info) {
    ...
    if (g_str_has_prefix (name, "epiphany-")) {
      ...
      if (len == 2) {
        ...
        file_info = g_file_query_info (old_desktop_file, G_FILE_ATTRIBUTE_STANDARD_SIZE, G_FILE_QUERY_INFO_NONE, NULL, NULL);
        ...
        link_file = g_file_new_for_path (app_desktop_file_name);
        g_file_make_symbolic_link (link_file, new_desktop_file_name, NULL, NULL);
      }
    }
