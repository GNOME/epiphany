                                 ...
                                 EphyActionBarEnd     *action_bar_end)
{
  if (ephy_downloads_manager_has_active_downloads (manager)) {
    gdouble progress = ephy_downloads_manager_get_estimated_progress (manager);
    dzl_progress_menu_button_set_progress (DZL_PROGRESS_MENU_BUTTON (action_bar_end->downloads_button), progress);
  }
}
...
ephy_action_bar_end_init (EphyActionBarEnd *action_bar_end)
{
  ...
  dzl_progress_menu_button_set_show_progress (DZL_PROGRESS_MENU_BUTTON (action_bar_end->downloads_button), TRUE);
  dzl_progress_menu_button_set_show_theatric (DZL_PROGRESS_MENU_BUTTON (action_bar_end->downloads_button), TRUE);
