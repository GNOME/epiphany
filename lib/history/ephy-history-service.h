...
void                     ephy_history_service_set_url_pinned          (EphyHistoryService *self, const char *url, gboolean pinned, GCancellable *cancellable, EphyHistoryJobCallback callback, gpointer user_data);
