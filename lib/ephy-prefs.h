...
#define EPHY_PREFS_SYNC_EXTENSIONS_ENABLED "sync-extensions-enabled"
#define EPHY_PREFS_SYNC_EXTENSIONS_TIME   "sync-extensions-time"
#define EPHY_PREFS_SYNC_EXTENSIONS_INITIAL "sync-extensions-initial"
