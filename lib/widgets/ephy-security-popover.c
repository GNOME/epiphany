...
ephy_security_popover_init (EphySecurityPopover *popover)
{
  ...
  GtkWidget *box;
  GtkSizeGroup *combo_box_size_group;
  ...
  popover->autoplay_combobox = add_permission_combobox (popover, _("Media autoplay"), on_autoplay_policy_combobox_changed, combo_box_size_group, FALSE, "Default");

  g_object_unref (combo_box_size_group);
