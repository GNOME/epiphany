...
#define CARD_EXPDATE_YEAR_YYYY_LABEL "GNOME Web Autofill - Credit Card Year Expiration Date - YYYY"
#define CARD_EXPDATE_MONTH_MM_LABEL  "GNOME Web Autofill - Credit Card Month Expiration Date - MM"
#define CARD_EXPDATE_MONTH_M_LABEL   "GNOME Web Autofill - Credit Card Month Expiration Date - M"
#define CARD_EXPDATE_YEAR_YY_LABEL   "GNOME Web Autofill - Credit Card Year Expiration Date - YY"
...
static void
get_key_and_label_for_field (EphyAutofillField field, const char **key, const char **label)
{
  switch (field)
  {
...
/**
 * ephy_autofill_storage_delete:
 * @field: an #EphyAutofillField
 * @callback: a #GAsyncReadyCallback
 * @user_data: a value passed to @callback
 *
 * Deletes the value stored for @field
 **/
void
                              ...
                              gpointer user_data)
{
  ...
  if (key != NULL) {
    secret_password_clear (SCHEMA, NULL,
                           callback, user_data,
                           FIELD_KEY, key,
                           NULL);
  }
...
/**
 * ephy_autofill_storage_get:
 * @field: an #EphyAutofillField
 * @callback: a #GAsyncReadyCallback
 * @user_data: a value passed to @callback
 *
 * Gets the value stored for @field
 **/
void
                           ...
                           gpointer user_data)
{
  ...
  if (key != NULL) {
    secret_password_lookup (SCHEMA, NULL,
                            callback, user_data,
                            FIELD_KEY, key,
                            NULL);
  }
...
/**
 * ephy_autofill_storage_set:
 * @field: an #EphyAutofillField
 * @value: (allow-none): the value to store for @field
 * @callback: a #GAsyncReadyCallback
 * @user_data: a value passed to @callback
 *
 * Stores @value as the value for @field
 **/
void
                           ...
                           gpointer user_data)
{
  ...
  if (label != NULL && key != NULL) {
    secret_password_store (SCHEMA, SECRET_COLLECTION_DEFAULT,
                           label, storable_value,
...
/**
 * ephy_autofill_storage_delete_finish:
 * @res: a #GAsyncResult
 *
 * Returns: whether @res associated with an ephy_autofill_storage_delete()
 *          function call has succeeded
 **/
bool
ephy_autofill_storage_delete_finish (GAsyncResult *res)
{
  return secret_password_store_finish (res, NULL);
}

/**
 * ephy_autofill_storage_get_finish:
 * @res: a #GAsyncResult
 *
 * Returns: (transfer full): an autofill stored value associated with @res
 **/
char *
ephy_autofill_storage_get_finish (GAsyncResult *res)
{
  return secret_password_lookup_finish (res, NULL);
}

/**
 * ephy_autofill_storage_set_finish:
 * @res: a #GAsyncResult
 *
 * Returns: whether @res associated with an ephy_autofill_storage_set()
 *          function call has succeeded
 **/
bool
