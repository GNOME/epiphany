            ...
            gpointer     user_data)
{
  ...
  html_file = g_resources_lookup_data ("/org/gnome/epiphany/pdfjs/viewer.html", 0, NULL);
  ...
  requested_uri = g_strdup_printf ("%s://%s/%s", soup_uri_get_scheme (uri), soup_uri_get_host (uri), soup_uri_get_path (uri));
