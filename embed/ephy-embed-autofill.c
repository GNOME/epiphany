                                 ...
                                 gpointer   user_data)
{
  ...
  ephy_web_view_autofill (message->view,
                          g_strdup (message->selector),
                          message->fill_choice);
                 ...
                 EphyAutofillFillChoice  fill_choice)
{
  ...
  g_signal_connect (popover,
                    "destroy",
                    G_CALLBACK (autofill_popover_destroy_cb),
                    message);
  g_signal_connect (button,
                    "clicked",
                    G_CALLBACK (autofill_fill_button_clicked_cb),
                    message);
                                        ...
                                        EphyWebView    *view)
{
  ...
  if (has_card_fields) {
    add_fill_button (_("Fill all with personal and credit card data"),
                     GTK_POPOVER (popover), GTK_BOX (box),
                     view,
                     css_selector,
  ...
  if (has_personal_fields) {
    add_fill_button (_("Fill all with personal data"),
                     GTK_POPOVER (popover),
                     GTK_BOX (box),
                     view,
                     css_selector,
  ...
  g_signal_connect (never_show_again_btn,
                    "clicked",
                    G_CALLBACK (autofill_never_show_clicked_cb),
                    message);
