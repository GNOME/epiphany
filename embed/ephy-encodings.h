...
/* from htmlparser/nsIParser.h */
/* note: the value order defines the priority */
typedef enum
{
	EMBED_ENCODING_UNINITIALISED		= 0,
	EMBED_ENCODING_WEAK_DOCTYPE_DEFAULT	= 1,
	EMBED_ENCODING_USER_DEFAULT		= 2,
	EMBED_ENCODING_DOCTYPE_DEFAULT		= 3,
	EMBED_ENCODING_CACHE			= 4,
	EMBED_ENCODING_PARENT_FRAME		= 5,
	EMBED_ENCODING_BOOKMARKS		= 6,
	EMBED_ENCODING_AUTODETECTION		= 7,
	EMBED_ENCODING_HINT_PREV_DOC		= 8,
	EMBED_ENCODING_META_TAG			= 9,
	EMBED_ENCODING_BOM			= 10,
	EMBED_ENCODING_CHANNEL			= 11,
	EMBED_ENCODING_PARENT_FORCED		= 12,
	EMBED_ENCODING_USER_FORCED		= 13,
	EMBED_ENCODING_OTHER_COMPONENT		= 14,
	EMBED_ENCODING_PREV_LOADING		= 15
}
EphyEncodingSource;
