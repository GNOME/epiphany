                ...
                FilterInfo                   *self)
{
  ...
  g_autoptr(WebKitUserContentFilter) wk_filter =
    webkit_user_content_filter_store_save_from_file_finish (self->manager->store,
                                                            result,
                                                            &error);
  if (wk_filter) {
                             ...
                             GFile      *json_file)
{
  ...
  gboolean load_from_source = FALSE;
...
ephy_filters_manager_constructed (GObject *object)
{
  ...
  g_autofree gchar *saved_filters_dir = wk_saved_filters_dir (manager);
