                            ...
                            EphyDocumentView *view)
{
  ...
  g_signal_connect (view->current_page, "activate", G_CALLBACK (on_current_page_activate), view);
