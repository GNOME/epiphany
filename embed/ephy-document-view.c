                        ...
                        EphyDocumentView *view)
{
  ...
  chooser = gtk_file_chooser_native_new ("Save File",
                                        NULL,
...
ephy_document_view_constructed (GObject *object)
{
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (view->sizing_mode), "Fit Page");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (view->sizing_mode), "Fit Width");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (view->sizing_mode), "Free");
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (view->sizing_mode), "Automatic");
